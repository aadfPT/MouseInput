...
namespace Gma.System.MouseKeyHook.Implementation
{
    internal abstract class EventFacade : IKeyboardMouseEvents
    {
        ...
        {
            add { GetMouseListener().MouseInput += value; }
            remove { GetMouseListener().MouseInput -= value; }
        }

        public event EventHandler<MouseEventExtArgs> MouseInputExt
        {
            add { GetMouseListener().MouseInputExt += value; }
            remove { GetMouseListener().MouseInputExt -= value; }
        }
